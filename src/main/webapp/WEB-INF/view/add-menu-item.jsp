...
<form:form class="add-form" action="/add-menu" method="post" modelAttribute="menuItem">
...
<div class="div1">
  ...
  <fmt:formatDate value="${menuItem.dateOfLaunch}" var="dateOfLaunch" pattern="yyyy/MM/dd" />
